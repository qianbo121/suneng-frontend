...
export const SUNENG_PROFILE_SEO = {
  ...
  description:
    '江苏苏能工业炉有限公司成立于 2006 年，国家高新技术企业（GR202432008987）。专注热处理工业炉研发制造，提供工业炉装备、节能改造和大修服务。累计交付 150+ 项目，覆盖钢铁、汽车零部件、能源装备等行业。',
  keywords: [
    '苏能工业炉',
    '江苏苏能工业炉有限公司',
    '苏能工业炉介绍',
...
export const PARTNER_SEO = {
  ...
  description:
    '苏能工业炉服务工贸合金、重工装备、不锈钢深加工、管阀部件、新能源、汽车零部件、金属热处理、紧固件、轴承和智能制造等行业客户。',
  keywords: ['工业炉合作伙伴', '热处理设备客户', '工业炉应用行业', '苏能工业炉客户'],
};
