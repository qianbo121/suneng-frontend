...
export const CONTACT_SEO = {
  ...
  ogDescription:
    '国家高新技术企业，成立于 2006 年，专注工业炉单机、配套件与整线交钥匙工程一体化解决方案，服务钢铁、有色金属、装备制造、能源装备等行业客户。',
};
...
export const FURNACE_RENOVATION_OVERHAUL_SEO = {
  ...
  description:
    '苏能工业炉提供工业炉节能改造、热处理炉大修、控制系统升级、炉衬翻新、烟气余热回收等服务。可对苏能自制设备及部分非苏能品牌工业炉提供评估改造。成立于 2006 年，累计交付 150+ 项目。',
  keywords: [
    '工业炉节能改造',
    '热处理炉大修',
    '工业炉改造',
  ...
  ogDescription:
    '成立于 2006 年，累计 150+ 工业炉项目。提供节能改造、整炉大修、控制系统升级、炉衬翻新等服务。可对苏能自制设备及部分非苏能品牌工业炉提供评估改造。',
