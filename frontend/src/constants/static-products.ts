...
const productDetails: Record<string, StaticProductDetail> = {
  'box-furnace': {
    ...
    scenarioCards: [
      { title: '已授权项目：铜合金线材室式电加热退火炉', text: '某铜材加工项目配置 4 台炉体，额定温度 700℃、使用温度约 550–700℃、每室约 200 kW，装料有效尺寸约 Φ1710 × 1600 mm，采用 PLC 控制。' },
  ...
  'trolley-furnace': {
    ...
    scenarioCards: [
      { title: '已授权项目：轴承钢丝球化退火炉', text: '某线材项目采用 10 × 3 × 2.2 m 台车式轴承钢丝球化退火炉；具体温度、装炉量与工艺曲线按对应线材规格确定。' },
      { title: '已授权项目：超大型燃气台车退火炉改造', text: '某重型工件项目炉膛约 13 × 7.4 × 4.3 m，额定温度 700℃，配置 14 套燃气烧嘴，助燃空气预热约 250–300℃；不把该项目参数外推为固定节能率。' },
  ...
  'mesh-belt-furnace': {
    ...
    scenarioCards: [
      { title: '已授权项目：REWF-45-9 马弗式保护气氛网带炉', text: '项目网带总成尺寸约 2100 × 200 × 50 mm，有效工作宽度约 180 mm，额定温度 950℃，产量约 60 kg/h，网带速度约 10–114 mm/min。' },
