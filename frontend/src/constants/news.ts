...
export const FALLBACK_NEWS_DETAIL: NewsApiItem = {
  ...
  contentZh: `
    ...
    <h2>一、项目背景</h2>
    <p>本项目为某行业领先大型热处理生产线的核心设备，主要用于大型结构件的正火、退火工艺处理。设备有效加热区尺寸达18m × 6m × 3.2m，载重大，对炉内均温性与稳定性要求极高，整线集高效、节能、稳定、智能的综合需求。</p>
    <h2>二、实施亮点</h2>
    <p>1. 结构设计：根据客户生产工艺与产能需求，优化炉体结构与热场布局，确保温度均匀性与工艺稳定性。</p>
    <p>2. 节能高效：采用全纤维炉衬与高效燃烧系统，配合烟气余热回收技术，显著降低能耗指标。</p>
