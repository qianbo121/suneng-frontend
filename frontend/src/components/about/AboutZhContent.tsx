...
export const ABOUT_ZH_SEO = {
  ...
  description:
    '江苏苏能工业炉有限公司专注工业炉、热处理炉、配套件与整线交付，具备国家高新技术企业、ISO 三体系认证和多项专利，并明确不承接感应加热、炼钢冶金、工业锅炉等业务边界。',
  keywords:
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '苏能专业从事工业炉、热处理炉、真空炉、可控气氛炉、锻造加热炉与工业窑炉的设计、制造、系统集成,以及主要炉型的大修与技改服务。',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '苏能严格执行 GB/T 30822《工业燃气加热装置安全要求》等行业国家标准,通过 ISO 9001 / 14001 / 45001 三体系认证,是国家高新技术企业(证书编号 GR202432008987,2024年认定),累计获得 29 项国家专利。同时具备 TUS(温度均匀性测试)/ SAT(系统准确度测试)服务能力,可承接现场测试与整改。',
      },
    },
  ],
};
...
const businessItems: Array<{
  ...
  {
    title: '工业炉与热处理装备制造',
    text: '覆盖周期式炉、连续式炉、真空与可控气氛炉、专用工艺炉、锻造加热炉、工业窑炉六大类装备，按工艺需求提供主要产品体系内的设备方案。',
  },
  {
    title: '整线交钥匙工程',
  ...
  {
    title: '工业炉大修与技改服务',
    text: '可对苏能自制设备及部分非苏能品牌工业炉提供大修、技改、搬迁复产和节能改造评估；进口炉需结合设备资料、控制系统、备件条件和现场状态综合判断,同步承接 TUS(温度均匀性)/ SAT(系统准确度)测试与整改。',
    link: {
...
const industries = [
  ...
  [
    '高端制造',
    '航空航天零部件、国防装备配套场景仅指热处理装备或工业炉设备配套，不代表苏能持有军品资质、国军标认证、AMS 2750、Nadcap 或 CQI-9 等特殊行业认证。',
  ],
...
const faqItems = [
  [
    'Q1:苏能工业炉主要做什么?',
    '苏能专业从事工业炉、热处理炉、真空炉、可控气氛炉、锻造加热炉与工业窑炉的设计、制造、系统集成,以及主要炉型的大修与技改服务。覆盖电阻式与燃气式两大加热方式,服务于热处理、锻造加热、工业干燥/固化、窑炉烧成/焙烧四大工序场景。',
  ],
  [
    'Q2:你们做不做感应炉(感应加热设备)?',
  ...
  [
    ...
    '可以评估。苏能可对苏能自制设备及部分非苏能品牌工业炉提供大修、技改、搬迁复产和节能改造评估；进口炉需结合设备资料、控制系统、备件条件和现场状态综合判断。',
  ],
  [
    'Q4:你们能做整线交钥匙工程吗?',
  ...
  [
    'Q5:能对接哪些行业标准?',
    '苏能严格执行 GB/T 30822《工业燃气加热装置安全要求》等行业国家标准,通过 ISO 9001 / 14001 / 45001 三体系认证,是国家高新技术企业(证书编号 GR202432008987,2024年认定),累计获得 29 项国家专利。同时具备 TUS(温度均匀性测试)/ SAT(系统准确度测试)服务能力,可承接现场测试与整改。',
  ],
  [
    'Q6:服务过哪些行业?',
    '苏能服务于汽车零部件、工程机械、矿山机械、农机、紧固件、齿轮、轴承、模具、刀具、锻铸件、压力容器、油气管材、风电、新能源、有色金属深加工、钢材深加工等主流制造行业,并为航空航天、国防装备等高端制造领域提供热处理装备配套支持。航空航天、国防装备相关表述仅指热处理装备或工业炉设备配套场景，不代表苏能持有军品资质、国军标认证、AMS 2750、Nadcap 或 CQI-9 等特殊行业认证。',
  ],
  [
    'Q7:能不能只买你们的配套件?',
      ...
      <div className="mx-auto max-w-[1660px] px-6 lg:px-[86px]">
        <section className={sectionClass} aria-labelledby="about-overview">
          ...
          <p className={paragraphClass}>
            ...
            <strong>热处理装备配套支持</strong>。相关表述仅指热处理装备或工业炉设备配套场景，不代表苏能持有军品资质、国军标认证、AMS 2750、Nadcap 或 CQI-9 等特殊行业认证。针对符合业务边界的细分场景，苏能可基于实际工艺与产能需求,提供从工艺方案设计到设备制造、安装调试、
