...
export const ABOUT_ZH_SEO = {
  ...
  description:
    '江苏苏能工业炉有限公司专注工业炉、热处理炉、配套件与整线交付，具备国家高新技术企业、ISO 三体系认证和 11 项专利，并明确不承接感应加热、炼钢冶金、工业锅炉等业务边界。',
  keywords:
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '是。苏能工业炉为国家高新技术企业,同时具备国家级科技型中小企业(2025)认定、ISO 9001 / 14001 / 45001 三体系认证和 11 项已授权专利。',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '苏能严格执行 GB/T 30822《工业燃气加热装置安全要求》等行业国家标准,通过 ISO 9001 / 14001 / 45001 三体系认证,是国家高新技术企业(证书编号 GR202432008987,2024年认定),同时具备国家级科技型中小企业(2025)认定和 11 项已授权专利。公司具备 TUS(温度均匀性测试)/ SAT(系统准确度测试)服务能力,可承接现场测试与整改。',
      },
    },
  ],
};
...
const faqItems = [
  ...
  [
    'Q5:能对接哪些行业标准?',
    '苏能严格执行 GB/T 30822《工业燃气加热装置安全要求》等行业国家标准,通过 ISO 9001 / 14001 / 45001 三体系认证,是国家高新技术企业(2024年认定,证书编号 GR202432008987),同时具备国家级科技型中小企业(2025)认定和 11 项已授权专利。公司具备 TUS(温度均匀性测试)/ SAT(系统准确度测试)服务能力,可承接现场测试与整改。',
  ],
  [
    'Q6:服务过哪些行业?',
    ...
    <>
      ...
      <div className="mx-auto max-w-[1660px] px-6 lg:px-[86px]">
        ...
        <section className={sectionClass} aria-labelledby="standards">
          ...
          <p className={paragraphClass}>
            公司持续投入研发与质量管控,将<strong>“双国家级资质 + 三体系认证 + 11项专利 + 4项商标”</strong>作为产品质量与服务能力的核心底座。
          </p>
        </section>
