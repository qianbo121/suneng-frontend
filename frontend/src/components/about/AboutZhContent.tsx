...
export const ABOUT_ZH_SEO = {
  ...
  description:
    '苏能工业炉专业从事电阻式与燃气式工业炉、热处理炉、真空炉、可控气氛炉、锻造加热炉及工业窑炉的设计、制造与系统集成,提供单机设备、整线交钥匙工程、大修与技改服务,对接 AMS 2750、CQI-9、Nadcap、ASME、API、GJB 等国内外资质体系。',
  keywords:
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '可对接 AMS 2750、CQI-9、Nadcap、ASME、API、GJB、特种设备制造许可、GB/T 30822 等国内外主流标准。',
      },
    },
  ],
};
...
const businessItems = [
  {
    title: '工业炉与热处理装备制造',
    text: '覆盖周期式炉、连续式炉、真空与可控气氛炉、专用工艺炉、锻造加热炉、工业窑炉六大类装备。',
  },
  {
    title: '整线交钥匙工程',
    text: '紧固件/螺栓/弹簧/链条热处理生产线、渗碳淬火生产线、光亮退火生产线、锻造加热生产线等整线交付。',
  },
  {
    title: '工业炉大修与技改服务',
    text: '不限自产、不限品牌、含进口炉,覆盖全炉型谱系的整炉大修、节能改造、控制系统升级、耐材翻新、加热元件更换、搬迁重装、复产复线;同步承接 AMS 2750/CQI-9 复检整改、TUS/SAT 测试与整改。',
  },
  {
    title: '配套件供应',
    text: 'PLC 控制柜、DCS、温控系统、硅碳棒、硅钼棒、电阻带、辐射管、热电偶、耐火保温材料、装出料机构、淬火冷却系统、循环风机等。',
  },
];
...
const industries = [
  ...
  ['能源装备', '风电主轴、风电法兰、风电齿轮、核电零部件、石化设备'],
  ['高端制造', '航空航天零部件、航发零部件、军工、兵器、武器装备'],
...
const outOfScopeItems = [
  ...
  ['建材窑炉中的不做项', '水泥窑、立窑、玻璃窑、玻璃熔窑、陶瓷烧成窑'],
  ['工业锅炉', '锅炉、工业锅炉、蒸汽锅炉'],
  ['铸造熔化', '冲天炉、化铁炉'],
  ['焚烧设备', '焚烧炉、垃圾焚烧炉'],
...
const faqItems = [
  ...
  [
    'Q5:能对接哪些行业标准?',
    '可对接 AMS 2750、CQI-9、Nadcap、ASME、API、GJB、特种设备制造许可、GB/T 30822 等,并可承接 TUS(温度均匀性)与 SAT(系统准确度)测试与整改。',
  ],
  [
    'Q6:服务过哪些行业?',
    '汽车零部件、工程机械、矿山机械、农机、紧固件、齿轮、轴承、模具、刀具、锻铸件、压力容器、油气管材、风电、核电、石化、航空航天、军工兵器等行业,以及板、带、线、管、棒型材厂家。',
  ],
  [
    'Q7:能不能只买你们的配套件?',
      ...
      <header className="border-b border-[#e5e8ef] bg-[#f6f8fb]">
        <div className="mx-auto max-w-[1660px] px-6 py-12 lg:px-[86px] lg:py-16">
          ...
          <p className="mt-6 max-w-[980px] text-[18px] leading-[1.9] text-[#344054] lg:text-[20px]">
            苏能工业炉是一家专业从事<strong>工业加热、热处理与窑炉装备</strong>
            设计、制造与系统集成的企业,业务覆盖
            <strong>电阻式与燃气式工业炉</strong>的全炉型谱系。
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-[1660px] px-6 lg:px-[86px]">
        <section className={sectionClass} aria-labelledby="about-overview">
          ...
          <p className={paragraphClass}>
            苏能工业炉为客户提供
            <strong>单机设备、配套件、整线交钥匙工程,以及全品牌全炉型的大修与技改服务</strong>
            。我们具备高温炉与高精度热处理炉的自主研发能力,可对接 AMS
            2750、CQI-9、Nadcap、ASME、API、GJB 等国内外主流标准与资质体系。
          </p>
          <p className={paragraphClass}>
            无论您来自<strong>汽车零部件、工程机械、风电核电、石化能源、航空航天、军工兵器</strong>
            ,还是
            <strong>紧固件、齿轮、轴承、模具、压力容器、油气管材</strong>
            等细分领域,苏能都能为您提供从工艺方案到整线落地的完整解决方案。
          </p>
        </section>
        ...
        <section className={sectionClass} aria-labelledby="product-matrix">
          ...
          <section aria-labelledby="matrix-kiln">
            ...
            <p className={paragraphClass}>
              隧道窑、梭式窑、辊道窑、回转窑(用于陶瓷、耐火材料、粉体焙烧、特种材料烧成)。
            </p>
          </section>
        </section>
        ...
        <section className={sectionClass} aria-labelledby="standards">
          ...
          <p className={paragraphClass}>
            AMS
            2750(航空航天热处理高温测量)、CQI-9(汽车行业热处理过程评审)、Nadcap(航空航天特殊过程认证)、ASME、API、GJB(国军标/军工认证)、特种设备制造许可、GB/T
            30822(工业燃气加热装置安全要求)。
          </p>
        </section>
