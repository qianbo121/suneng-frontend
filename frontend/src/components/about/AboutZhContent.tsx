...
export const ABOUT_ZH_SEO = {
  title:
    '苏能工业炉_江苏工业炉厂家_整线交钥匙工程_国家高新技术企业_台车炉/井式炉/网带炉',
  description:
    '江苏苏能工业炉有限公司是工业炉单机、配套件与整线交钥匙工程的国家高新技术企业,深耕工业加热与热处理装备的设计、制造与系统集成,业务覆盖电阻式与燃气式工业炉的全炉型谱系,服务汽车零部件、工程机械、风电、新能源、有色金属深加工、钢材深加工、航空航天、国防装备等领域,提供从工艺方案到整线落地的一体化解决方案。',
  keywords:
    '工业炉,江苏工业炉,工业炉厂家,整线交钥匙工程,国家高新技术企业,台车炉,井式炉,网带炉,罩式炉,推杆炉,辊底炉,转底炉,热处理炉,真空炉,可控气氛炉,渗碳淬火生产线,光亮退火生产线,工业炉大修与技改',
  ogTitle: '江苏苏能工业炉｜工业炉与整线交钥匙工程一体化解决方案商',
  ogDescription:
    '国家高新技术企业,提供台车炉、井式炉、网带炉、罩式炉等全炉型工业炉,以及渗碳淬火、光亮退火、铜丝退火等整线交钥匙工程。覆盖汽车零部件、工程机械、风电、新能源、有色金属深加工、钢材深加工等领域。',
} as const;
