...
const profileFallbackParagraphs = {
  zh: [
    ...
    '公司产品广泛服务于汽车与工程机械零部件、齿轮、轴承、紧固件、弹簧、模具、刀具、锻件铸件、压力容器、油气管材、风电（主轴/法兰/齿轮）、核电零部件、石化设备、矿山机械、农机件，以及航空航天零部件、航发零部件与国防装备相关配套场景；同时对接钢厂、有色金属带材厂、管材厂等型材客户，承接板、带、线、管、棒材的热处理装备配套。航空航天、国防装备相关表述仅指热处理装备或工业炉设备配套场景，不代表苏能持有军品资质、国军标认证、AMS 2750、Nadcap 或 CQI-9 等特殊行业认证。',
  ...
  en: [
    ...
    'The company serves automotive and construction machinery components, gears, bearings, fasteners, springs, molds, cutting tools, forgings, castings, pressure vessels, oil and gas pipes, wind power parts such as main shafts, flanges and gears, nuclear power components, petrochemical equipment, mining machinery and agricultural machinery. Aerospace, aero-engine or defense-related wording refers only to industrial furnace or heat treatment equipment support and does not imply special industry certification. It also supports steel mills, non-ferrous strip plants and pipe manufacturers with heat treatment equipment for plates, strips, wires, pipes and bars.',
