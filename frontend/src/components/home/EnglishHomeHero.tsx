...
const companyStats = [
  { value: 2006, fractionDigits: 0, useGrouping: false, unit: '', label: 'Founded' },
  {
    value: 50.8,
    fractionDigits: 1,
    useGrouping: false,
  ...
  { value: 150, fractionDigits: 0, useGrouping: false, suffix: '+', unit: '', label: 'Employees' },
  { value: 14700, fractionDigits: 0, useGrouping: true, unit: 'm²', label: 'Production Site' },
] as const;
    ...
    <section className={styles.hero} aria-labelledby="english-hero-title">
      ...
      <div className={styles.heroContainer}>
        <div className={`${styles.heroCopy} ${styles.englishCopy}`}>
          ...
          <h1 id="english-hero-title" className={`${styles.title} ${styles.englishTitle}`}>
