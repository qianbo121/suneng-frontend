...
const toolbarCopy = {
  zh: [
    ...
    { key: 'phone', label: '电话联系', href: 'tel:+8613052986814', icon: HiOutlinePhone, type: 'link' as const },
    { key: 'top', label: '返回顶部', href: '#top', icon: HiChevronUp, type: 'top' as const },
  ],
  en: [
    { key: 'wechat', label: 'WeChat', type: 'wechat' as const },
    { key: 'phone', label: 'Call', href: 'tel:+8613052986814', icon: HiOutlinePhone, type: 'link' as const },
