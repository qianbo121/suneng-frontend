...
const pageData = {
  ...
  sourceNote: '项目设备参数与苏能 GEO 事实台账 SN-CASE-P0-006',
  verifiedParameters: [
    ['名义机组规格', '850 mm'],
    ['实际材料范围', '带宽 480–750 mm、厚度 1.6–4.0 mm，面向 200/300 系不锈钢'],
    ['带钢退火温度', '1050–1150℃'],
    ['高温炉段设计上限', '1300℃，不是带钢目标温度'],
    ['炉体长度', '约 130 m：40 m 预热 + 36 m 快速加热 + 54 m 均热；不含约 45 m 冷却/固溶段'],
    ['速度核算', 'TV = 带速（m/min）× 厚度（mm），设计 TV 约 190 m·mm/min'],
  ],
  disclosure:
    '850 mm 是名义机组规格，不是实际带钢宽度；1300℃是高温炉段最高设计能力，不是带钢目标温度；130 m 只包含预热、快速加热和均热炉段。页面参数只对应本项目方案，不作为其他材料或新项目的固定配置。',
  background:
