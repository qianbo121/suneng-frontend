...
const pageData = {
  ...
  verifiedParameters: [
    ...
    ['加热炉额定温度', '950℃'],
    ['有效加热区', '6400 × 300 × 300 mm'],
    ['最大设计处理能力', '500 kg/h，方案折算约 30 件/h'],
  ],
  disclosure:
    '页面公开的 500 kg/h 与约 30 件/h 均为技术方案中的最大设计能力，不是实际验收产能；实际处理能力取决于工件尺寸、单件重量、装料方式、加热时间和生产节拍。联系人、报价、合同条款、完整图纸、控制图、供应商清单和 PLC 程序不公开。',
  background:
