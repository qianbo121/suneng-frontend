...
const bottlenecks = [
  ...
  {
    title: '瓶颈 2：烟气热能浪费',
    text: '原有烟气回收仅做单级助燃空气预热，烟气出炉温度仍偏高。通过多级回收，可将钢带预热、空气预热和余热锅炉产蒸汽组合起来进一步利用烟气余热。',
  },
  {
...
const solutionModules = [
  ...
  {
    title: '模块 B：三级烟气余热回收',
    intro: '由单级助燃空气预热升级为钢带预热、助燃空气预热、余热锅炉产蒸汽的三级递进式回收。',
    items: [
      '第 1 级：利用高温段烟气对入炉钢带预热，降低退火加热段负荷。',
      '第 2 级：利用中温段烟气对助燃空气预热，提升燃烧效率。',
      '第 3 级：利用低温段烟气通过余热锅炉产生工艺蒸汽，供应至客户酸洗工序。',
...
const implementationStages = [
  ...
  },
  {
    ...
    items: [
      '烧嘴、控制柜、变频柜、余热锅炉等核心设备在苏能 14,700 ㎡ 生产基地制造。',
...
const technicalDetails = [
  ...
  },
  {
    ...
    paragraphs: [
      '炉膛出口烟气先用于钢带预热，再用于空气预热，最后通过余热锅炉回收低温段热量。每一级回收都对应不同换热设备设计，包括高温辐射换热结构、管式或板式换热器和标准余热锅炉。',
      ...
      <section className="relative overflow-hidden bg-[#101828] text-white">
        ...
        <div className="relative mx-auto max-w-[1180px] px-5 py-14 lg:px-8 lg:py-20">
          <Breadcrumb
            ...
            className="text-[13px]"
            items={[
              { label: '案例', href: '/zh/case' },
              { label: 'A3 服务页', href: servicePath },
            ]}
          />
          ...
          <div className="mt-10 max-w-[980px]">
            ...
            <p className="mt-7 max-w-[940px] rounded-[8px] bg-white/10 p-5 text-[15px] leading-[1.9] text-white/78">
              ...
              本案例所列数据均基于该项目实际测算结果。具体节能效益与原炉型结构、燃料类型、产线负荷、保温状态、控制系统、运行制度和现场工况密切相关，需以现场诊断和改造方案测算为准。本案例数据仅作为同类工程参考，不构成对其他项目的节能效果承诺。
            </p>
